...
adDiscription = "الحرارة بكافة انواعها , هي أحدى اشكال الطاقة الفيزيائية , تحدث اثناء حركة الذرات أو الجزيئات أو أي جسيم يدخل في تركيب المادة . تتنقل الحرارة بين الأجسام بالتوصيل و الإشعاع الحراري والحمل الحراري . وتنتقل الحرارة تلقائيًا من درجة الحرارة الأعلى للأدنى.و درجة الحرارة هي مقياس مدى سخونة جسم ما أو برودته، وهي التي تحدد اتجاه انتقال الحرارة تلقائيًا، إلا أنه ممكن استنفاذ شغل لنقلها في الاتجاه المعاكس.أما  السعة الحرارية فهي كمية الحرارة اللازمة لرفع درجة حرارة جسم ما .و التغير في كمية حرارة الجسم تساوي حاصل ضرب حرارته النوعية x كتلته x التغير في درجة حرارته ."
