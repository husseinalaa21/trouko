...
adDiscription = "أن عمر الكون ، في علم الكون الفيزيائي هو المدة الزمنية المستغرقة منذ نشأه الكون أي ' منذ الانفجار العظيم ' لحد الآن (بوجود احتمالات عدة في التغير الزماني). , و يُقدّر عمر الكون بنحو(13.799±0.021)مليار سنة طبقًا لنموذج 'لامبدا-سي دي إم Lambda-CDM concordance model'.و ترتبط مشكلة قياس عمر الكون ارتباطًا وثيقًا مع مشكلة حساب قيم المقاييس الكونيّة .و بدأ ظهور مفهوم أن عمر الأرض يقدّر بملايين السنين في القرن الثامن عشر . حيث اعتقد العلماء ف القرن التاسع عشر وفي بدايات القرن العشرين أن الكون ثابت ولانهائيّ مع بعض النجوم التي تمضي وتذهب ، إلا أن التغيرات الكبيرة ليس لها مكان في الكون في نظرهم ."
