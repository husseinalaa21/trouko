...
adDiscription = "أن عمر الكون ، في علم الكون الفيزيائي هو المدة الزمنية المستغرقة منذ نشأه الكون أي ' منذ الانفجار العظيم ' لحد الآن 11-4بوجود احتمالات عدة في التغير الزماني11-5. , و يُقدّر عمر الكون بنحو 11-4 13.799±0.021 11-5 مليار سنة طبقًا لنموذج 'لامبدا11-1سي دي إم Lambda11-1CDM concordance model'.و ترتبط مشكلة قياس عمر الكون ارتباطًا وثيقًا مع مشكلة حساب قيم المقاييس الكونيّة .و بدأ ظهور مفهوم أن عمر الأرض يقدّر بملايين السنين في القرن الثامن عشر . حيث اعتقد العلماء ف القرن التاسع عشر وفي بدايات القرن العشرين أن الكون ثابت ولانهائيّ مع بعض النجوم التي تمضي وتذهب ، إلا أن التغيرات الكبيرة ليس لها مكان في الكون في نظرهم ."
namePpath = "https://trouko.com/questions/questions_space/ما_هو_عمر_الكون/"
