...
adDiscription = "الطاقة المضلمة في الفيزياء و علم الكون هي احد الاشكال الافتراظية للطاقة التي تملأ الفضاء و تحيط به و هي تمتلك ضغطاً سالبأ.وفي النظرية العامة لاينشتاين أن الضغط السالب لهذه الطاقه يكون مشابهاً لقوة معاكسة للجاذبية في المقاييس الكبيرة .و حسب ايضاً النسبية العامة ان هذا التأثير الناجم عن الطاقة المضلمة هو الاكثر شعبية حالياً لتفسير تمدد الكون بمعدل نتسارع"
namePpath = "https://trouko.com/questions/questions_space/ما_هي_الطاقة_المضلمة/"
