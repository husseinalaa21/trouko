var ad_sub_one , ad_sub_two , ad_sub_three,
 ...
 ad_sources_quotes_five , ad_sources_quotes_six ,tP, ad_sources_quotes_seven , ad_sources_quotes_index , numberSuoces,hide_text;
...
tP = document.getElementById('h_d_n')
...
function addTime(m){
    ...
    proveA.innerHTML = "  <p> بواسطة مدونة تروكو </p> <i class='fa fa-check-circle'></i> "
